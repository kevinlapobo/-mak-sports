<x-layouts.auth :title="'Register'" :heading="'Join Makerere Sports'" :subheading="'Create your account to access personalized sports content'">
    <form class="space-y-5" method="POST" action="{{ route('register.post') }}">
        ...
        <div>
            ...
            <input id="name" name="name" type="text" required
                class="mt-1 appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#006633] focus:border-transparent"
                value="{{ old('name') }}">
        </div>
        ...
        <div>
            ...
            <select id="role" name="role" required
                class="mt-1 block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#006633] focus:border-transparent"
    ...
    <div class="mt-6 text-center">
        ...
        <a href="{{ route('login') }}" class="ml-1 font-semibold text-[#006633] hover:text-[#004d26]">
            Sign in here
        </a>
    </div>
