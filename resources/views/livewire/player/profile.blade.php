    ...
    <div style="max-width:650px; margin:0 auto; padding:0 16px;">
        ...
        <div style="background:#fff; border-radius:16px; border:1px solid #e5e7eb; overflow:hidden;">
            <div style="background:linear-gradient(135deg, var(--muk-green) 0%, var(--muk-green-dark) 100%); padding:24px; text-align:center;">
                ...
                <h1 style="font-size:20px; font-weight:900; color:#fff; margin:0;">⚽ Player Profile</h1>
            ...
            <form wire:submit="updateProfile" style="padding:24px;">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Position</label>
                        <input type="text" wire:model="position" placeholder="e.g. Forward, Midfielder" style="width:100%; padding:10px 12px; border:1px solid #e5e7eb; border-radius:8px; font-size:14px;">
                    </div>
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Jersey Number</label>
                        <input type="number" wire:model="jersey_number" min="0" max="99" style="width:100%; padding:10px 12px; border:1px solid #e5e7eb; border-radius:8px; font-size:14px;">
                    </div>
                </div>

                <div style="margin-bottom:24px;">
                    <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Faculty / Department</label>
                    <input type="text" wire:model="faculty" placeholder="e.g. College of Computing" style="width:100%; padding:10px 12px; border:1px solid #e5e7eb; border-radius:8px; font-size:14px;">
                </div>
