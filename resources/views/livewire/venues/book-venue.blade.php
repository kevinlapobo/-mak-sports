    ...
    <div style="max-width:700px; margin:0 auto;">
        ...
        <div style="background:#fff; border-radius:16px; border:1px solid #e5e7eb; overflow:hidden;">
            ...
            <div style="background:#fef2f2; border-left:4px solid #CC0000; padding:16px 20px; margin:16px; border-radius:0 8px 8px 0;">
                <div style="font-size:14px; font-weight:700; color:#CC0000;">⚠️ Venue Already Booked</div>
            ...
            @if($errors->any())
            <div style="background:#fef2f2; border-left:4px solid #CC0000; padding:16px 20px; margin:16px; border-radius:0 8px 8px 0;">
                <div style="font-size:14px; font-weight:700; color:#CC0000;">⚠️ Please fix the following errors:</div>
            ...
            <form wire:submit="submit" style="padding:24px;">
                ...
                <div style="margin-bottom:24px;">
                    <label style="font-size:14px; font-weight:700; color:#333; display:block; margin-bottom:10px;">Booking Type <span style="color:#CC0000;">*</span></label>
                    <div style="display:flex; gap:16px;">
                        <label style="flex:1; padding:14px 18px; border:2px solid {{ $booking_type === 'immediate' ? '#CC0000' : '#e5e7eb' }}; border-radius:10px; cursor:pointer; {{ $booking_type === 'immediate' ? 'background:#fef2f2;' : 'background:#fff;' }}">
                            <input type="radio" wire:model.live="booking_type" value="immediate" style="accent-color:#CC0000;">
                        ...
                        <label style="flex:1; padding:14px 18px; border:2px solid {{ $booking_type === 'non_immediate' ? '#CC0000' : '#e5e7eb' }}; border-radius:10px; cursor:pointer; {{ $booking_type === 'non_immediate' ? 'background:#fef2f2;' : 'background:#fff;' }}">
                            <input type="radio" wire:model.live="booking_type" value="non_immediate" style="accent-color:#CC0000;">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Purpose <span style="color:#CC0000;">*</span></label>
                    ...
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Expected Attendees <span style="color:#CC0000;">*</span></label>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px; margin-bottom:16px;">
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Date <span style="color:#CC0000;">*</span></label>
                        <input type="date" wire:model.live="booking_date" min="{{ date('Y-m-d') }}" required style="width:100%; padding:10px 12px; border:1px solid {{ $conflict ? '#CC0000' : '#e5e7eb' }}; border-radius:8px; font-size:14px;">
                    </div>
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">Start Time <span style="color:#CC0000;">*</span></label>
                        <input type="time" wire:model.live="start_time" required style="width:100%; padding:10px 12px; border:1px solid {{ $conflict ? '#CC0000' : '#e5e7eb' }}; border-radius:8px; font-size:14px;">
                    </div>
                    <div>
                        <label style="font-size:13px; font-weight:600; color:#333; display:block; margin-bottom:4px;">End Time <span style="color:#CC0000;">*</span></label>
                        <input type="time" wire:model.live="end_time" required style="width:100%; padding:10px 12px; border:1px solid {{ $conflict ? '#CC0000' : '#e5e7eb' }}; border-radius:8px; font-size:14px;">
                    </div>
                </div>
